...
Configuration: [`KafkaStoragePortBuilder`](https://docs.rs/photon-backend-kafka/latest/photon_backend_kafka/struct.KafkaStoragePortBuilder.html) (options + example). Index: [docs.rs `photon::config`](https://docs.rs/photon/latest/photon/config/#storage-adapter-builders).
