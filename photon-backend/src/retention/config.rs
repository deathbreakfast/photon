...
///
/// See the retention section in [`photon::config`](https://docs.rs/photon/latest/photon/config/index.html).
#[must_use]
...
///
/// See the transport section in [`photon::config`](https://docs.rs/photon/latest/photon/config/index.html).
#[must_use]
