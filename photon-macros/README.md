...
Requires `#[photon::topic]` and `Photon::start_executor` at boot for inventory handlers. Attribute reference: [docs.rs `photon::config` — proc macros](https://docs.rs/uf-photon/latest/photon/config/#proc-macro-attributes). Expansion behavior: [`docs/macro-expansion.md`](../docs/macro-expansion.md).
