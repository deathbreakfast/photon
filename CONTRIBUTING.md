...
2. Update [`docs/configuration.md`](docs/configuration.md) when env vars, macro attributes, or builder options change (renders on [docs.rs `photon::config`](https://docs.rs/photon/latest/photon/config/)).
...
- Backend adapter crate docs should link to their `*StoragePortBuilder` rustdoc; cross-cutting env vars stay in [`photon::config`](https://docs.rs/photon/latest/photon/config/index.html).
